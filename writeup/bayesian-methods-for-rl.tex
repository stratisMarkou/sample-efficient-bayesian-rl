...
\item Add agent parameter details.
...
\item BQL may suffer from bad updates and lack of a forgetting mechanism.
\item MM produces well calibrated uncertainties in this setting, no need to tune $\zeta$.
\item Correlations are very important for optimal action selection.
\item No clear computational advantage of any of the methods over PSRL.
...
We thus propose first solving for the greedy policy $\pi^*$ w.r.t. $p(\thetamct | \data)$ and $p(\thetamcr | \data)$, and then for the epistemic uncertainty in $\mu_{z^*_{\s, \ac}}$. The latter is used for Thompson sampling from a diagonal gaussian, resulting in a factored approximation of the posterior as in the UBE. A derivation outline and further details are given in appendix \ref{app:mm}.

\section{Finite MDP environments}

We compare the algorithms on three kinds of finite MDPs of variable sizes, and all experiments are in the continuing setting - exact specifications and illustrations given in \cref{app:env}. We measure performance by the cumulative regret to an oracle agent which acts under the optimal policy.
...
Visualisations of the posterior evolution on small MDPs illustrate a number of interesting phenomena (\crefrange{ql_deepsea_visual}{mm_deepsea_visual}, \crefrange{ql_widenarrow_visual}{mm_widenarrow_visual} and \crefrange{ql_priormdp_visual}{mm_priormdp_visual}). We also show evaluations of the algorithms in terms of cumulative regret to an oracle which always picks the optimal action.

In general, the posteriors concentrate on the true $Q^*$ values. As the posteriors narrow down, the behaviour policy converges on the optimal policy and the agent smoothly transitions into greedy and optimal action selection. Further, the agent does not over-explore actions if it is confident that these are suboptimal. This is clearly seen in \crefrange{bql_deepsea_visual}{mm_deepsea_visual}, where the posterior confidently claims that the optimal action $(\s = 4, \ac = \textit{right})$ is better than the suboptimal one $(\s = 4, \ac = \textit{left})$, whilst simultaneously there is significant uncertainty in the expected return of the suboptimal action: the agent does not spend its time determining the exact expected return of an action if it is confident that it is suboptimal.

However, there are notable exceptions to the above behaviour. First, the UBE uncertainty estimate $u^*_{\s, \ac}$ is extremely loose, even after many time-steps have passed (\cref{ube_deepsea_visual1}, \cref{ube_widenarrow_visual1} and \cref{ube_priormdp_visual1}). Even though $\mu_{\zob}$ be close to $Q^*$, $u^*_{\s, \ac}$ is so large that the Thompson noise completely smooths out differences between actions and actions are picked almost uniformly at random. Further, $u^*_{\s, \ac}$ shrinks very slowly and the transition to greedy behaviour takes an extremely long time, causing poor regret performance. These effects are due to the extremely large $Q_{\max}$-term in the local uncertainty (\cref{eq:bellunc} and \cref{eq:localunc}) is extremely large\footnote{}. Further, $u^*_{\s, \ac}$ is dominated by uncertainty in the dynamics rather than the rewards (\cref{ube_unc_terms}).

If the Thompson noise is scaled by $\zeta < 1.0$, a plateauing regret can be observed in some cases. However, one is further faced by the challenge of tuning $\zeta$. In large problems it may be expensive to repeat runs just to pick an appropriate value for $\zeta$ and the situation would likely be worse if it turns out that $\zeta$ must be annealed.

\section{Conslusions \& Further work}
...
\centering
\begin{subfigure}{0.65\textwidth}
\includegraphics[width=\linewidth]{img/bql-0_0-1_0-2_0-2_0-posterior-deepsea-4.pdf}
\end{subfigure}
\begin{subfigure}{0.34\textwidth}
\includegraphics[width=\linewidth]{img/bql-0_0-1_0-2_0-2_0-regret-deepsea-4.pdf}~\\~\\
\end{subfigure}
\captionsetup{width=0.9\linewidth}
...
\centering
\begin{subfigure}{0.65\textwidth}
\includegraphics[width=\linewidth]{img/psrl-0_0-1_0-2_0-2_0-posterior-deepsea-4.pdf}
\end{subfigure}
\begin{subfigure}{0.34\textwidth}
\includegraphics[width=\linewidth]{img/psrl-0_0-1_0-2_0-2_0-regret-deepsea-4.pdf}~\\~\\
\end{subfigure}
\captionsetup{width=0.9\linewidth}
...
\centering
\begin{subfigure}{0.65\textwidth}
\includegraphics[width=\linewidth]{img/ube-0_0-1_0-2_0-2_0-1_0-posterior-deepsea-4.pdf}
\end{subfigure}
\begin{subfigure}{0.34\textwidth}
\includegraphics[width=\linewidth]{img/ube-0_0-1_0-2_0-2_0-1_0-regret-deepsea-4.pdf}~\\~\\
\end{subfigure}
\captionsetup{width=0.9\linewidth}
...
\vspace{-1cm}
\begin{subfigure}{0.65\textwidth}
\includegraphics[width=\linewidth]{img/ube-0_0-1_0-2_0-2_0-0_1-posterior-deepsea-4.pdf}
\end{subfigure}
\begin{subfigure}{0.34\textwidth}
\includegraphics[width=\linewidth]{img/ube-0_0-1_0-2_0-2_0-0_1-regret-deepsea-4.pdf}~\\~\\
\end{subfigure}
\captionsetup{width=0.9\linewidth}
...
\centering
\begin{subfigure}{0.65\textwidth}
\includegraphics[width=\linewidth]{img/mm-0_0-1_0-2_0-2_0-1_0-posterior-deepsea-4.pdf}
\end{subfigure}
\begin{subfigure}{0.34\textwidth}
\includegraphics[width=\linewidth]{img/mm-0_0-1_0-2_0-2_0-1_0-regret-deepsea-4.pdf}~\\~\\
\end{subfigure}
\captionsetup{width=0.9\linewidth}
...
\centering
\begin{subfigure}{0.65\textwidth}
\includegraphics[width=\linewidth]{img/bql-1_5-1_0-2_0-2_0-posterior-widenarrow-1-6.pdf}
\end{subfigure}
\begin{subfigure}{0.34\textwidth}
\includegraphics[width=\linewidth]{img/bql-1_5-1_0-2_0-2_0-regret-widenarrow-1-6.pdf}~\\~\\
\end{subfigure}
\captionsetup{width=0.9\linewidth}
...
\centering
\begin{subfigure}{0.65\textwidth}
\includegraphics[width=\linewidth]{img/psrl-0_0-1_0-2_0-2_0-posterior-widenarrow-1-6.pdf}
\end{subfigure}
\begin{subfigure}{0.34\textwidth}
\includegraphics[width=\linewidth]{img/psrl-0_0-1_0-2_0-2_0-regret-widenarrow-1-6.pdf}~\\~\\
\end{subfigure}
\captionsetup{width=0.9\linewidth}
...
\centering
\begin{subfigure}{0.65\textwidth}
\includegraphics[width=\linewidth]{img/ube-0_0-1_0-2_0-2_0-1_0-posterior-widenarrow-1-6.pdf}
\end{subfigure}
\begin{subfigure}{0.34\textwidth}
\includegraphics[width=\linewidth]{img/ube-0_0-1_0-2_0-2_0-1_0-regret-widenarrow-1-6.pdf}~\\~\\
\end{subfigure}
\captionsetup{width=0.9\linewidth}
...
\vspace{-1cm}
\begin{subfigure}{0.65\textwidth}
\includegraphics[width=\linewidth]{img/ube-0_0-1_0-2_0-2_0-0_1-posterior-widenarrow-1-6.pdf}
\end{subfigure}
\begin{subfigure}{0.34\textwidth}
\includegraphics[width=\linewidth]{img/ube-0_0-1_0-2_0-2_0-0_1-regret-widenarrow-1-6.pdf}~\\~\\
\end{subfigure}
\captionsetup{width=0.9\linewidth}
...
\centering
\begin{subfigure}{0.65\textwidth}
\includegraphics[width=\linewidth]{img/mm-0_0-1_0-2_0-2_0-1_0-posterior-widenarrow-1-6.pdf}
\end{subfigure}
\begin{subfigure}{0.34\textwidth}
\includegraphics[width=\linewidth]{img/mm-0_0-1_0-2_0-2_0-1_0-regret-widenarrow-1-6.pdf}~\\~\\
\end{subfigure}
\captionsetup{width=0.9\linewidth}
...
\includegraphics[width=\linewidth]{img/bql-0_0-1_0-2_0-2_0-scatter-widenarrow-1-6-500.pdf}
\end{subfigure}\\
~\\
~\\
\begin{subfigure}{1.0\textwidth}
\includegraphics[width=\linewidth]{img/psrl-0_0-1_0-2_0-2_0-scatter-widenarrow-1-6-500.pdf}
\end{subfigure}\\
~\\
~\\
\begin{subfigure}{1.0\textwidth}
\includegraphics[width=\linewidth]{img/ube-0_0-1_0-2_0-2_0-0_1-scatter-widenarrow-1-6-500.pdf}
\end{subfigure}\\
~\\
~\\
\begin{subfigure}{1.0\textwidth}
\includegraphics[width=\linewidth]{img/mm-0_0-1_0-2_0-2_0-1_0-scatter-widenarrow-1-6-500.pdf}
\end{subfigure}\\
\captionsetup{width=0.9\linewidth}
\caption{Correlation plots for WideNarrow at time step $t = 500$.}\label{correlations_widenarrow_500}
\end{figure}

\begin{figure}[h!]
\centering
\begin{subfigure}{1.0\textwidth}
\includegraphics[width=\linewidth]{img/bql-0_0-1_0-2_0-2_0-scatter-widenarrow-1-6-2500.pdf}
\end{subfigure}\\
~\\
~\\
\begin{subfigure}{1.0\textwidth}
\includegraphics[width=\linewidth]{img/psrl-0_0-1_0-2_0-2_0-scatter-widenarrow-1-6-2500.pdf}
\end{subfigure}\\
~\\
~\\
\begin{subfigure}{1.0\textwidth}
\includegraphics[width=\linewidth]{img/ube-0_0-1_0-2_0-2_0-0_1-scatter-widenarrow-1-6-2500.pdf}
\end{subfigure}\\
~\\
~\\
\begin{subfigure}{1.0\textwidth}
\includegraphics[width=\linewidth]{img/mm-0_0-1_0-2_0-2_0-1_0-scatter-widenarrow-1-6-2500.pdf}
\end{subfigure}\\
\captionsetup{width=0.9\linewidth}
\caption{Correlation plots for WideNarrow at time step $t = 2,500$.}\label{correlations_widenarrow_2500}
\end{figure}
...
\centering
\begin{subfigure}{0.65\textwidth}
\includegraphics[width=\linewidth]{img/bql-0_0-1_0-2_0-2_0-posterior-priormdp-4-2.pdf}
\end{subfigure}
\begin{subfigure}{0.34\textwidth}
\includegraphics[width=\linewidth]{img/bql-0_0-1_0-2_0-2_0-regret-priormdp-4-2.pdf}~\\~\\
\end{subfigure}
\captionsetup{width=0.9\linewidth}
...
\centering
\begin{subfigure}{0.65\textwidth}
\includegraphics[width=\linewidth]{img/psrl-0_0-1_0-2_0-2_0-posterior-priormdp-4-2.pdf}
\end{subfigure}
\begin{subfigure}{0.34\textwidth}
\includegraphics[width=\linewidth]{img/psrl-0_0-1_0-2_0-2_0-regret-priormdp-4-2.pdf}~\\~\\
\end{subfigure}
\captionsetup{width=0.9\linewidth}
...
\centering
\begin{subfigure}{0.65\textwidth}
\includegraphics[width=\linewidth]{img/ube-0_0-1_0-2_0-2_0-1_0-posterior-priormdp-4-2.pdf}
\end{subfigure}
\begin{subfigure}{0.34\textwidth}
\includegraphics[width=\linewidth]{img/ube-0_0-1_0-2_0-2_0-1_0-regret-priormdp-4-2.pdf}~\\~\\
\end{subfigure}
\captionsetup{width=0.9\linewidth}
...
\centering
\begin{subfigure}{0.65\textwidth}
\includegraphics[width=\linewidth]{img/ube-0_0-1_0-2_0-2_0-0_1-posterior-priormdp-4-2.pdf}
\end{subfigure}
\begin{subfigure}{0.34\textwidth}
\includegraphics[width=\linewidth]{img/ube-0_0-1_0-2_0-2_0-0_1-regret-priormdp-4-2.pdf}~\\~\\
\end{subfigure}
\captionsetup{width=0.9\linewidth}
\caption{UBE posterior and regret on PriorMDP.}\label{ube_priormdp_visual1}
\end{figure}
...
\centering
\begin{subfigure}{0.65\textwidth}
\includegraphics[width=\linewidth]{img/mm-0_0-1_0-2_0-2_0-1_0-posterior-priormdp-4-2.pdf}
\end{subfigure}
\begin{subfigure}{0.34\textwidth}
\includegraphics[width=\linewidth]{img/mm-0_0-1_0-2_0-2_0-1_0-regret-priormdp-4-2.pdf}~\\~\\
\end{subfigure}
\captionsetup{width=0.9\linewidth}
...
\centering
\begin{subfigure}{1.0\textwidth}
\includegraphics[width=\linewidth]{img/bql-0_0-1_0-2_0-2_0-scatter-priormdp-4-2-500.pdf}
\end{subfigure}\\
~\\
~\\
\begin{subfigure}{1.0\textwidth}
\includegraphics[width=\linewidth]{img/psrl-0_0-1_0-2_0-2_0-scatter-priormdp-4-2-500.pdf}
\end{subfigure}\\
~\\
~\\
\begin{subfigure}{1.0\textwidth}
\includegraphics[width=\linewidth]{img/ube-0_0-1_0-2_0-2_0-0_1-scatter-priormdp-4-2-500.pdf}
\end{subfigure}\\
~\\
~\\
\begin{subfigure}{1.0\textwidth}
\includegraphics[width=\linewidth]{img/mm-0_0-1_0-2_0-2_0-1_0-scatter-priormdp-4-2-500.pdf}
\end{subfigure}\\
\captionsetup{width=0.9\linewidth}
\caption{Correlation plots for PriorMDP at time step $t = 500$.}\label{correlations_priormdp_500}
\end{figure}

\begin{figure}[h!]
\centering
\begin{subfigure}{1.0\textwidth}
\includegraphics[width=\linewidth]{img/bql-0_0-1_0-2_0-2_0-scatter-priormdp-4-2-2500.pdf}
\end{subfigure}\\
~\\
~\\
\begin{subfigure}{1.0\textwidth}
\includegraphics[width=\linewidth]{img/psrl-0_0-1_0-2_0-2_0-scatter-priormdp-4-2-2500.pdf}
\end{subfigure}\\
~\\
~\\
\begin{subfigure}{1.0\textwidth}
\includegraphics[width=\linewidth]{img/ube-0_0-1_0-2_0-2_0-0_1-scatter-priormdp-4-2-2500.pdf}
\end{subfigure}\\
~\\
~\\
\begin{subfigure}{1.0\textwidth}
\includegraphics[width=\linewidth]{img/mm-0_0-1_0-2_0-2_0-1_0-scatter-priormdp-4-2-2500.pdf}
\end{subfigure}\\
\captionsetup{width=0.9\linewidth}
\caption{Correlation plots for PriorMDP at time step $t = 2,500$.}\label{correlations_priormdp_2500}
\end{figure}

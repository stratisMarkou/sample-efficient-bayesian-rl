...
We observe several trends in our results. \Cref{combined_regret_summary} shows the regret, normalised by the oracle's cumulative reward to make the performances comparable on the same scale - see appendix \ref{app:supfig} for further results and supporting figures.
\begin{figure}[h!]
\centering
